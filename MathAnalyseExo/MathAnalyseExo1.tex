...
Si $a_n=o(\sqrt{n})$, alors $\dfrac{a_n}{n}=o(\dfrac1{\sqrt{n}})$ et nous pouvons faire un développement limité
\begin{align*}
...
Pour la réciproque, supposons que 
\[e^{a_n} \sim \left (1+\dfrac{a_n}{n}\right )^n\]
Ce qui est équivalent à 
\[ a_n-n\ln(1+\frac{a_n}{n})\rightarrow 0 \]
...
Si nous notons $f$ la fonction qui à $x$ associe $f(x)=x-\ln(1+x)$, $f(x)=0 \iff x=0$ et donc $\dfrac{a_n}{n}-\ln(1+\dfrac{a_n}{n})$ ne peut pas tendre vers $0$.\p
...
Donc forcément, $\dfrac{a_n^2}{n} \rightarrow 0 \iff a_n=o(\sqrt{n})$, d'où le résultat.\p
